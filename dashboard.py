...
class IMS:
    def __init__(self,root):
        ...
        #====Left menu===
        self.MenuLogo=Image.open("pictures/menu_im.png")
        ...
        self.icon_side=PhotoImage(file="pictures/side.png")
        ...
        #====footer====
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Sudhanhsu & Rakshit\nFor any Technical Issue contact:7985xxxx01",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#========================================================================================
    ...
    def update_content(self):
        ...
        try:
            ...
            self.lbl_sales.config(text=f'Toatal Sales\n[{str(bill)}]')            

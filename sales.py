...
class salesClass:
    def __init__(self,root):
        ...
        #====title=====
        lbl_title=Label(self.root,text="Customer Bill Reports",font=("goudy olsd style",30),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        lbl_title2=Label(bill_frame,text="Customer Bill Area",font=("goudy olsd style",20),bg="orange").pack(side=TOP,fill=X)
   ...
   #==============Image===========
        self.bill_photo=Image.open("pictures/cat2.jpg")

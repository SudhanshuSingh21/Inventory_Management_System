...
class employeeClass:
    def __init__(self,root):
       ...
       #row4===================== 
        ...
        txt_salary=Entry(self.root,textvariable=self.var_sal,font=("goudy old style",15),bg="lightyellow").place(x=600,y=270,width=180)
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="" :
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This Employ ID already assigned, try different",parent=self.root)
                else:
    ...
    def update(self):
        ...
        try:
            if self.var_emp_id.get()=="" :
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error","Invalid Emoloyee ID",parent=self.root)
                else:
